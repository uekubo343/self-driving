...
Reward+TotalDistance/2
坂道のアクセルの評価値を5倍に
坂道での評価方法を変更（変位→次のポイントへのベクトル）
直線でのアクセルの評価値を2倍に

0~14,15,16,,40,41,42,43,44,45,46,47,49,50
角度
50-70-90-110-130
10-30-50-70-90
30-150
...
ratio(distanceに対するrewardの割合)は1.7~1.9程度→2.5程度
