...
// // 自分でAIを実装する場合 -------------------------------------------------------------
// [CreateAssetMenu(menuName = "BattleBrain/v51BattleBrain")]
// public class v51BattleBrain : BattleBrain {
...
// ニューラルネットワークのAIを使う場合 --------------------------------------------------
[CreateAssetMenu(menuName = "BattleBrain/v51BattleBrain")]
public class v51BattleBrain : NNBattleBrain
{
    /// <summary>
    /// 使用するセンサーの設定.
    /// </summary>
    ...
    /// `v51BattleBrain`ではInspectorのSelected Inputsで選択したセンサーの値を使う.
    /// </summary>
    public override double[] GetAction(List<double> observation)
    {
...
// // Q学習のAIを使う場合 ----------------------------------------------------------------
// [CreateAssetMenu(menuName = "BattleBrain/v51BattleBrain")]
// public class v51BattleBrain : QBattleBrain
// {
//     /// <summary>
